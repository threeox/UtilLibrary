package com.threeox.utillibrary.util.anim;
 ...
 * @author 赵屈犇
 * 
 * @date 创建时间:2016-9-19 上午10:54:43
 * 
 */
public final class AnimationUtils {
	 ...
	 * @return 一个透明度渐变动画
	 */
	public static AlphaAnimation getAlphaAnimation(float fromAlpha,
	 ...
	 */
	public static AlphaAnimation getAlphaAnimation(float fromAlpha,
			float toAlpha, AnimationListener animationListener) {
		return getAlphaAnimation(fromAlpha, toAlpha,
				DEFAULT_ANIMATION_DURATION, animationListener);
	}
